...
export default function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main ref={containerRef} className="bg-origen min-h-screen">
      ...
      {/* Content */}
      <section className="py-24 px-6 md:px-24 flex justify-center">
        <div className="max-w-4xl w-full text-center md:text-left">
          {/* Main Content */}
          <div className="space-y-12">
            <p className="font-lato text-2xl md:text-3xl text-presencia leading-relaxed">
              {project.description}
            </p>

            {project.videoUrl && (
              <div className="aspect-video w-full bg-black/20 rounded-lg overflow-hidden border border-silencio/10">
                <iframe
