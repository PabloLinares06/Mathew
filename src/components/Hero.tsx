  ...
  return (
    <section id="home" className="relative w-full min-h-screen overflow-hidden bg-origen flex items-center justify-center py-20 md:py-32">
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-7xl mx-auto">
        ...
        >
          <div className="w-full max-w-[350px] md:max-w-[750px] lg:max-w-[1100px] filter drop-shadow-[0_0_60px_rgba(226,28,34,0.5)] leading-[0] overflow-hidden flex items-center justify-center h-[250px] md:h-[500px] lg:h-[700px]">
